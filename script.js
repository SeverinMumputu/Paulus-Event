...
document.addEventListener("keydown", e => {
    if (e.key === "Escape") closeViewer();
        ...
        const galleryData = [
            ...
            { id: 7, event: 'mariage-kalonji', category: 'Service', url: 'consommation.jpg', desc: 'Consommation des boissons - 21h20' },
            { id: 8, event: 'mariage-kalonji', category: 'Service', url: 'repas.jpg', desc: 'Repas - 21h20' },
            { id: 9, event: 'mariage-kalonji', category: 'Repas', url: 'Partage.jpg', desc: 'Partage du gâteau - 22h20' },
            { id: 10, event: 'mariage-kalonji', category: 'Photo', url: 'mains_2.jpg', desc: 'Séance photo avec la mariée - 22h20' },
            { id: 11, event: 'mariage-kalonji', category: 'Photo', url: 'photo_avec_mariee.jpg', desc: 'Paulus Event avec les mariés - 22h30' },
            { id: 12, event: 'mariage-kalonji', category: 'Photo', url: 'photo_avec_marie_2.jpg', desc: 'Paulus Event près des mariés - 22h30' },
            { id: 13, event: 'mariage-kalonji', category: 'Photo', url: 'photo_avec_mariee_3.jpg', desc: 'Paulus Event avec les mariés - 22h20' },
            
            { id: 14, event: 'paulus_mariiage_kalonji', category: 'Coordination', url: 'supervision.jpg', desc: 'Supervision et ajustements - 17h00' },
            { id: 15, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'Mise_en_place.jpg', desc: 'Mise en place du personnel - 17h15' },
            { id: 16, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'Mise_en_place_2.jpg', desc: 'Mise en place du personnel - 17h15' },
            { id: 17, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'arrivee_invite.jpg', desc: 'Accueil des invités - 18h00' },
            { id: 18, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'reception.jpg', desc: 'Réception des invités - 18h05' },
            { id: 19, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'positionnement.jpg', desc: 'Positionnement par secteurs - 18h15' },
            { id: 20, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'debut_service.jpg', desc: 'Partage de boissons - 21h20' },
            { id: 21, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'photo_ensemble_1.jpg', desc: 'Photo ensemble 1 - 22h20' },
            { id: 22, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'photo_ensemble_2.jpg', desc: 'Photo ensemble 2 - 22h20' },
            { id: 23, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'photo_ensemble_4.jpg', desc: 'Photo ensemble 3 - 22h20' },
            { id: 24, event: 'paulus_mariiage_kalonji', category: 'Service', url: 'photo_ensemble_3.jpg', desc: 'Photo ensemble 4 - 22h20' },
